    ...
    const handleFormValues = (event, handlertype) => {
        ...
        switch (handlertype) {
            ...
            case 'password':
                ...
                break;
            case 'rememberMe':
                tempValues['rememberMe'] = event.target.value;
                setFormValues(tempValues);
                break;
            case 'showPassword':
                tempValues['showPassword'] = !tempValues['showPassword'];
                setFormValues(tempValues);
                break;
            default:
                setFormValues(tempValues);
                ...
                <h2 className='text-3xl font-extrabold uppercase my-8'>Login</h2>
                    <div className='text-white'>
                        <form onSubmit={(e) => e.preventDefault()}>
                            <fieldset>
                                <div class="mx-3 my-0">
                                    <p class="text-sm font-medium my-3.5 text-black">Please enter your e-mail address and password.</p>
                                </div>
                                ...
                                <div className='flex justify-end'>
                                    <button className='bg-black flex justify-center items-center gap-2 uppercase text-center text-white py-3 hover:scale-y-125 px-20'>
                                        login 
